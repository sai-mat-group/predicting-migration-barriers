...
data = 'MPT-SN-Em-5-images-train.json'
epochs = 500
...
layers_to_copy = ['atom_embedding', 'edge_embedding', 'angle_embedding', 'alignn_layers', 'gcn_layers'] # The layers from which to load pre-trained parameters
