...
learning_rate = 1e-3 
prop_indices = [1]  # This is the index of the property - taken from the OH column
n_early_stopping = 30
n_outputs=6 # Dimensions of the original MPR model, 6
n_hidden=1 # Number of hidden layers in the head
print_outputs=False
checkpoint_dir = './fine-tune-phonon/' # Where all your checkpoints will be saved
checkpoint_fp = 'best_model-phonon.pt' # The checkpoint of the general model to load up initially
