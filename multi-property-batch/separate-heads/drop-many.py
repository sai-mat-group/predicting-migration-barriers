...
data = '../../data/complete_dataset.json'
...
n_hidden=1
print_outputs=False
checkpoint_fp = 'dropped-column-3/checkpoint_140.pt'
...
for i in range(1): ## Loop across each of the indices
    checkpoint_dir = './dropped-column-%s' % str(i)
    prop_indices = [0, 1, 2, 3, 4, 5, 6]
    prop_indices.remove(drop_indices)
