...
data = 'gv_random_sample.json'  # The data to test on
model_path = 'checkpoint_best_val.pt' # The model checkpoint to load initially
...
with open('results.txt', 'w') as f:
    f.write('\n r2: {0:4f}'.format(r2_score(ground_truth, results)))
    f.write('\n mae: {0:4f}'.format(mean_absolute_error(ground_truth, results)))
    f.write('\n Ignored {} cases'.format(ignored))
